...
///
/// Postgres `col_name` keywords may appear bare as column/table names but not
/// as type/function names; `type_func_name` keywords the reverse.
